...
sf_df_lions <- st_as_sf(DF_lions_data_clean, coords = c("utme", "utmn"), crs = 32736)

#Save the sf dataframe - can only do it once when it is not created before
DB_lions_sf <- sf::st_write(sf_df_lions, "data_files/DB_lions_sf.shp")
```
...
DB_lions_wgs84 <- sf::st_write(DB_lions_wgs84, "data_files/DB_lions_wgs84.shp")
