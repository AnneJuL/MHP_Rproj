...
-   Time of year ? 
            --> I really want to find a way to get this...
...
RandomPointsCD_landcover <- sf::st_write(RandomPointsCD_landcover, "data_files/RandomPointsCD_landcover.shp", delete_dsn = TRUE)
...
# 4. Bring back to R
sampled_elevation_sf <- ee_as_sf(sampled_elevation, maxFeatures = 5000)
...
# Bring to R
sampled_ndvi_sf <- ee_as_sf(sampled_ndvi)
View(sampled_ndvi_sf)
