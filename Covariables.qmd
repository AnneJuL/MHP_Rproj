...
RandomPointsCD_yearly_data <- sf::st_read("data_files/RandomPointsCD_yearly_data.shp")
...
Now we want to get the land cover for the Masaai Mara. With this we will be able to get those covariables:
